defmodule PapyrusWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PapyrusWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PapyrusWeb.Gettext, "errors", msg, opts)
    end
  end
